...
namespace Nico.ECC.Template
{
    public abstract class TemplateEntityMonoBehavior<T> : MonoBehaviour, IEntity
    {
        ...
        protected readonly List<IController<T>> controllers = new();

        [Sirenix.OdinInspector.ShowInInspector]
        protected readonly List<IComponent<T>> components = new();
    ...
    public abstract class TemplateNetworkEntityMonoBehavior<T> : NetworkBehaviour, IEntity
    {
        [Sirenix.OdinInspector.ShowInInspector]
        protected readonly List<IController<T>> controllers = new();
